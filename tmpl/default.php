...
else {$bgmodulemedia="mod_formatic";}

//Select surrounds source folder

$surmodulemedia='mod_formatic';
...
if ($surroundstyle=="custom"){$surroundpx=$custompx;$surmodulemedia="mod_formatic";}

//colours & backgrounds

$bgpattern = $params->get('bgpattern');

if($bgpattern == "custom"){$bgmodulemedia="mod_formatic";}
